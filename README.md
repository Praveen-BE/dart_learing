...
<summary>
- ☑️ Hello Wolrd!
the file run main by using Terminal using
</summary>
main.dart
...
```
Core Topics/greet.dart (file path)
```dart
...
####  2. type inference and flexible type
...
####  3. Specific data type, nullable, non nullable
<details>
...
####  4. Late variables and how it works
<details>
...
```dart
  ...
  //whose values must be known at compile time and cannot be changed later.
  const pi = 3.14159;
  print(pi);

  // final - runtime constant, its value is 
  //assigned once at runtime and cannot be changed later.
...
#### 7. _ use cases & some generic function
...
Iterables and collection methods
...
Streams and handling sequences of data
...
Using pub.dev to add dependencies
...
Running code in parallel using isolates
...
Building server apps with Dart VM
...
Though technically separate, Dart is the foundation of Flutter



Widgets, state management, and UI building
